MEMO="banner spread envelope side kite person disagree path silver will brother under couch edit food venture squirrel civil budget number acquire point work mass"
KEY="some"
...
echo $MEMO | evmosd keys add $KEY --recover --keyring-backend $KEYRING --algo $KEYALGO
