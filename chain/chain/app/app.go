...
import (
	...
	intertxkeeper "github.com/tharsis/evmos/v4/x/inter-tx/keeper"
	intertxtypes "github.com/tharsis/evmos/v4/x/inter-tx/types"
	...
	intertx "github.com/tharsis/evmos/v4/x/inter-tx"
)
...
func NewEvmos(
	...
	app.Erc20Keeper = erc20keeper.NewKeeper(
		keys[erc20types.StoreKey], appCodec, appCodec, app.GetSubspace(erc20types.ModuleName),
		app.AccountKeeper, app.BankKeeper, app.EvmKeeper, &app.InterTxKeeper,
	)
	...
	app.mm.SetOrderBeginBlockers(
		...
		icatypes.ModuleName, intertxtypes.ModuleName,
	)
