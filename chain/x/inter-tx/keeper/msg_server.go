...
func (k msgServer) SubmitTx(goCtx context.Context, msg *types.MsgSubmitTx) (*types.MsgSubmitTxResponse, error) {
	...
	k.Logger(ctx).Debug("inter tx msg server", "msg", msg.GetSigners())
	err := k.SubmitTxICA(ctx, msg.ConnectionId, msg.Owner, msg.GetTxMsg())

	return &types.MsgSubmitTxResponse{}, err
}
